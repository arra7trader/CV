...
const getTechIcon = (tech: string) => {
  const iconMap: Record<string, string> = {
    ...
    'AI SDK': 'heroicons:cpu-chip-solid',
    'LibSQL': 'heroicons:circle-stack-solid',
    'Turso': 'heroicons:circle-stack-solid',
    'Recharts': 'heroicons:chart-bar-solid',
    'Framer Motion': 'simple-icons:framer',
    'Provider': 'heroicons:puzzle-piece-solid',
    'FL Chart': 'heroicons:chart-bar-solid',
    'WebView': 'heroicons:globe-alt-solid',
    'WebSocket': 'heroicons:signal-solid',
    'MetaTrader 5': 'heroicons:chart-bar-square-solid',
    'MQL5': 'heroicons:code-bracket-solid',
    'Pine Script': 'heroicons:code-bracket-square-solid',
    'LSTM': 'heroicons:cpu-chip-solid',
    'GRU': 'heroicons:cpu-chip-solid',
    'SQLite': 'simple-icons:sqlite',
    'Better Auth': 'heroicons:shield-check-solid',
    'OpenAI': 'simple-icons:openai',
    'Octokit': 'simple-icons:github',
    'Gemini AI': 'heroicons:sparkles-solid',
  }
